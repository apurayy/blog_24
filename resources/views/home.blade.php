    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
      <div class="row align-items-center px-3">
        ...
        <div class="col-lg-6 text-center text-lg-right">
          <img class="img-fluid mt-5" src="{{asset('fontend/img/header.png')}}" alt="" />
        </div>
      </div>
    </div>
    <!-- Header End -->
        ...
        <div class="row align-items-center">
          <div class="col-lg-5">
            <img
              ...
              src="{{asset('fontend/img/about-1.jpg')}}"
              alt=""
            />
          </div>
          <div class="col-lg-7">
            ...
            <div class="row pt-2 pb-4">
              <div class="col-6 col-md-4">
                <img class="img-fluid rounded" src="{{asset('fontend/img/about-2.jpg')}}" alt="" />
              </div>
